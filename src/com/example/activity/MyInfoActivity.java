...
import com.encount.tools.RoundedImageView;
...
public class MyInfoActivity extends Activity implements OnClickListener {
	...
	private RoundedImageView iv = null;
	// 昵称输入
	TextView tvName;
	EditText name;
	// 性别
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.edit_mine_info_main);
		// 初始化
		init();
		updateName();
		tvName.setOnClickListener(this);
		findViewById(R.id.rl_six).setOnClickListener(this);
		findViewById(R.id.edit_my_birth).setOnClickListener(this);
		findViewById(R.id.back_floation).setOnClickListener(this);
	}
	 ...
	 */
	private void init() {
		iv = (RoundedImageView) findViewById(R.id.edit_img);
		iv.setOnClickListener(this);
		tvSix = (TextView) findViewById(R.id.my_six);
	...
	public void onClick(View v) {
		...
		case R.id.rl_six:
			ShowUpdateSix();
			break;
		case R.id.edit_my_birth:
			date = new DatePicker(MyInfoActivity.this);
			date.setCalendarViewShown(false);
			new AlertDialog.Builder(MyInfoActivity.this).setTitle("请选择您的生日")
					.setView(date)
					.setPositiveButton("完成", dateListener)
					.show();
			break;
		case R.id.my_name:
			name = new EditText(MyInfoActivity.this);
			name.setText(tvName.getText());
			new AlertDialog.Builder(MyInfoActivity.this).setTitle("请输入")
					.setIcon(android.R.drawable.ic_dialog_info).setView(name)
					.setPositiveButton("确定", btnOk)
					.setNegativeButton("取消", btnCancel).show();
			break;
		case R.id.back_floation:
			finish();
			break;
		default:
			break;
	...
	private void ShowUpdateSix() {
		// TODO Auto-generated method stub
		final String[] sixs = new String[] { "男", "女", "保密" };
		new AlertDialog.Builder(this).setTitle("请选择")
				.setItems(sixs, new DialogInterface.OnClickListener() {

					@Override
					public void onClick(DialogInterface dialog, int which) {
						// TODO Auto-generated method stub
						tvSix.setText(sixs[which]);
					}
				}).show();
	}
	...
	private void updateName() {
		if (tvName == null)
			tvName = (TextView) findViewById(R.id.my_name);
	}
